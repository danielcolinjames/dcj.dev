  ...
  return (
    <ContentBackground bgc="#fff">
      <MainContentContainer>
        ...
        <BodyText>
          One of the newest features in Storybook (released in version 5.2) is a
          new way to define the order in which Storybook will display your
          stories. Yay!
        </BodyText>
        <BodyText>
          I'm hopeful that the documentation of these new features will improve
          over time, but until then, I figured I'd write a blog post to describe
          how to use the new storySort function, and hopefully save someone some
          time that I spent figuring this out.
        </BodyText>
